...
def test_get_pad_size():
    ...
    assert get_pad_size(0, 63) == 64
    assert get_pad_size(64, 64) == 64
    assert get_pad_size(65, 64) == 128
    assert get_pad_size(64, 128) == 128
    assert get_pad_size(0, 64) == 0
    assert get_pad_size(-1, 64) == 0
